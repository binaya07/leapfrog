var GAME_FPS = 100;
var FRAME_INTERVAL = 1000/GAME_FPS;
...
function Game(){
    ...
    this.addRoadWrapper = function(){
        ...
        this.addRoadImage('images/game-bg-1.png');
        this.addRoadImage('images/game-bg-1.png');
        this.addRoadImage('images/game-bg-1.png');
    ...
    this.createCar = function(isMyCar, leftPos, bottomPos){
        ...
        if(isMyCar){
            this.myCar = new Car(this.container, 'url(images/bike.png)', leftPos, bottomPos);
            this.myCar.init();
        }
        else{
            var car1 = new Car(this.container, 'url(images/ob-car.png)', leftPos, bottomPos);
            car1.init();
...
function start(gameOver){
    ...
    if(!gameOver){
        ...
        title.innerHTML = 'MotoGP 90s with BULLET';
        ...
        over.innerHTML = 'Press SPACE_BAR to shoot bullets';
