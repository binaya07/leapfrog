...
function slider(n){
    ...
    indicatorDiv.onclick = xyz;

    function xyz(e){
        
        indicators = indicatorDiv.children
    ...
    function init(){
        ...
        carouselContainer = document.getElementsByClassName('carousel-container')[n];
        ...
        totalImages = parseInt(carouselImagesList.length);
    }
